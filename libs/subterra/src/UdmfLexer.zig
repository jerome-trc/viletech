// Generated by re2c 3.1 on Sun Oct 27 20:01:39 2024
...
pub fn next(self: *Self) ?udmf.Token {
    ...
    while (true) {
        switch (yystate) {
            0 => {
                yych = if (self.yycursor < self.yylimit) self.yyinput[self.yycursor] else 0;
                switch (yych) {
                    0x01...0x20 => {
                        self.yycursor += 1;
                        yystate = 3;
