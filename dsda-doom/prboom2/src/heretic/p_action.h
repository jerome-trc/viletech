...
void A_BeakAttackPL1(CCore*, struct player_s*, struct pspdef_s*);
void A_BeakAttackPL2(CCore*, struct player_s*, struct pspdef_s*);
void A_BeakRaise(CCore*, struct player_s*, struct pspdef_s*);
void A_BeakReady(CCore*, struct player_s*, struct pspdef_s*);
...
void A_FireBlasterPL1(CCore*, struct player_s*, struct pspdef_s*);
void A_FireBlasterPL2(CCore*, struct player_s*, struct pspdef_s*);
void A_FireCrossbowPL1(CCore*, struct player_s*, struct pspdef_s*);
void A_FireCrossbowPL2(CCore*, struct player_s*, struct pspdef_s*);
void A_FireGoldWandPL1(CCore*, struct player_s*, struct pspdef_s*);
void A_FireGoldWandPL2(CCore*, struct player_s*, struct pspdef_s*);
void A_FireMacePL1(CCore*, struct player_s*, struct pspdef_s*);
void A_FireMacePL2(CCore*, struct player_s*, struct pspdef_s*);
void A_FirePhoenixPL1(CCore*, struct player_s*, struct pspdef_s*);
void A_FirePhoenixPL2(CCore*, struct player_s*, struct pspdef_s*);
void A_FireSkullRodPL1(CCore*, struct player_s*, struct pspdef_s*);
void A_FireSkullRodPL2(CCore*, struct player_s*, struct pspdef_s*);
void A_FlameEnd(CCore*, mobj_t*);
void A_FlameSnd(CCore*, mobj_t*);
void A_FloatPuff(CCore*, mobj_t*);
void A_FreeTargMobj(CCore*, mobj_t*);
void A_GauntletAttack(CCore*, struct player_s*, struct pspdef_s*);
...
void A_InitPhoenixPL2(CCore*, struct player_s*, struct pspdef_s*);
...
void A_ShutdownPhoenixPL2(CCore*, struct player_s*, struct pspdef_s*);
...
void A_StaffAttackPL1(CCore*, struct player_s*, struct pspdef_s*);
void A_StaffAttackPL2(CCore*, struct player_s*, struct pspdef_s*);
