...
static void gld_PrecalculateSector(int num)
{
  ...
  // set callbacks
  gluTessCallback(tess, GLU_TESS_BEGIN, (void(CALLBACK*)(void))ntessBegin);
  gluTessCallback(tess, GLU_TESS_VERTEX, (void(CALLBACK*)(void))ntessVertex);
  gluTessCallback(tess, GLU_TESS_ERROR, (void(CALLBACK*)(void))ntessError);
  gluTessCallback(tess, GLU_TESS_COMBINE, (void(CALLBACK*)(void))ntessCombine);
  gluTessCallback(tess, GLU_TESS_END, (void(CALLBACK*)(void))ntessEnd);
